...
-- The skin RealRP uses. Set to "default" to use the GMod default derma theme.
GM.Config.RealRPSkin = "RealRP"
GM.Config.currency = "$"
GM.Config.chatCommandPrefix = "/"
GM.Config.F1MenuHelpPage = ""
GM.Config.F1MenuHelpPageTitle = ""

-- The sound that plays when you get a RealRP notification
...
-- Make sure the category is created in the RealRP_customthings/categories.lua, otherwise it won't work!
